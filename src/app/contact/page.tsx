  ...
  return (
    <div className="mx-auto max-w-4xl px-6 md:px-8 py-20">
      ...
      <div className="mt-14 space-y-10 text-[15px] leading-relaxed text-muted max-w-[62ch]">
        <p>
          For speaking invitations, message me on LinkedIn or X; a ready-made
          bio and headshot are in the{" "}
          <a href="/speaker" className="text-[var(--accent)] hover:underline">
            speaker kit
          </a>
          . For bugs and contributions to my open-source projects, open an
          issue or PR on the relevant GitHub repository. For everything else,
          email works:{" "}
